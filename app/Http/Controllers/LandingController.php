            ...
            foreach ($landing as $key  => $column) {
               if (in_array( $key , $moduls) && $column == 1){
                    ...
                    if ($key =='section_3') {
                        ...
                        $images = $this->getImage($modul[0]->partners()->get());
                    ...
                    elseif($key =='section_5') {
                        ...
                        $image = $this->getImage($modul->where('is_right' , 1)->where('is_title' , 1)->all() , 'image' , 'image');
                        ...
                        $image = $this->getImage($modul->where('is_title' , 0)->all() , 'statistic_image' , 'image');
                        // dd($modul);
