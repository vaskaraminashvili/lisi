...
<body>
    ...
    <div class="socials">
        <ul>
            <li><a target="_blank" class="" href="{{$socials->facebook}}"><i class="fab fa-facebook-square"></i></a></li>
            <li><a target="_blank" href="{{$socials->twitter}}"><i class="fab fa-twitter"></i></a></li>
            <li><a target="_blank" href="{{$socials->instagram}}"><i class="fab fa-instagram"></i></a></li>
            <li><a target="_blank" href="{{$socials->youtube}}"><i class="fab fa-youtube"></i></a></li>
            <li><a target="_blank" href="{{$socials->email}}"><i class="fas fa-envelope"></i></a></li>
        </ul>
    </div><!-- /.socials -->
    <div class="feedback">
    ...
    <script>
        ...
        $(document).ready(function() {
          $('#fullpage').fullpage({
            // menu: '#myMenu',
            // anchors: ['landing_home'  , 'season' , 'about_project' , 'project_info', 'project_summary' , 'apartment' , 'footer'],
            anchors: [
