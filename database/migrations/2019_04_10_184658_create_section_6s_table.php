...
class CreateSection6sTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Section_6s", 'section_6s', 'title', 'fa-cube', [
            ...
            ["room_name_1", "Room Name 1", "String", false, "", 0, 256, false],
            ["meter_1", "Room Square Meter 1", "String", false, "", 0, 256, false],
            ["room_name_2", "Room Name 2", "String", false, "", 0, 256, false],
            ["meter_2", "Room Square Meter 2", "String", false, "", 0, 256, false],
            ["room_name_3", "Room Name 3", "Address", false, "", 0, 256, false],
            ["meter_3", "Room Square Meter 3", "String", false, "", 0, 256, false],
            ["room_name_4", "Room Name 4", "String", false, "", 0, 256, false],
            ["meter_4", "Room Square Meter 4", "String", false, "", 0, 256, false],
            ["room_name_5", "Room Name 5", "String", false, "", 0, 256, false],
            ["meter_5", "Room Square Meter 5", "String", false, "", 0, 256, false],
            ["room_name_6", "Room Name 6", "String", false, "", 0, 256, false],
            ["meter_6", "Room Square Meter 6", "String", false, "", 0, 256, false],
    ...
    {
        if (Schema::hasTable('section_6s')) {
            Schema::drop('section_6s');
        }
    }
}
