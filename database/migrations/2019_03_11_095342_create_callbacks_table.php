...
class CreateCallbacksTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Callbacks", 'callbacks', 'firstname', 'fa-cube', [
            ["firstname", "Name", "String", false, "", 0, 256, false],
            ["phone", "Phone", "String", false, "", 0, 256, false],
            ["project", "Project", "String", false, "", 0, 256, false],
            ["email", "Email", "Email", false, "", 0, 256, false],
            ["active", "Contacted Back", "Checkbox", false, "false", 0, 0, false],
        ]);
