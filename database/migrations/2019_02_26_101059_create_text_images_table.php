...
class CreateTextImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Text_images", 'text_images', 'title_ka', 'fa-cube', [
            ...
            ["tag_id", "Tag", "Dropdown", false, "", 0, 256, false, "@tags"],
        ]);
    ...
    {
        if (Schema::hasTable('text_images')) {
            Schema::drop('text_images');
        }
    }
}
