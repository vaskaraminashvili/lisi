...
class CreateAboutProjectsTable extends Migration
{
    ...
    {
        if (Schema::hasTable('about_projects')) {
            Schema::drop('about_projects');
        }
    }
}
