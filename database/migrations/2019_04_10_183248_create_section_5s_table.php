...
class CreateSection5sTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Section_5s", 'section_5s', 'title', 'fa-cube', [
            ...
            ["is_title", "Is Title", "Checkbox", false, "1", 0, 0, false],
            ["statistic_prefix", "Statistic Prefix", "String", false, "", 0, 3, false],
            ["statistic_number", "Statistic Number", "Integer", false, "", 0, 3, false],
            ["statistic_sufix", "Statistic Sufix", "String", false, "", 0, 3, false],
            ["statistic_text", "Statistic Text", "String", false, "", 0, 50, false],
