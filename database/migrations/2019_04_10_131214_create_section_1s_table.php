...
class CreateSection1sTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Section_1s", 'section_1s', 'title', 'fa-cube', [
            ...
            ["thumbnail", "Youtube Thumbnail", "Image", false, "", 0, 0, false],
            ["youtube_link", "YouTube Link", "String", false, "", 0, 256, false],
    ...
    {
        if (Schema::hasTable('section_1s')) {
            Schema::drop('section_1s');
        }
    }
}
