...
class CreateGreenZonesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Green_zones", 'green_zones', 'title_ka', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('green_zones')) {
            Schema::drop('green_zones');
        }
    }
}
